...
public class Visitor2 implements Vistor{
    @Override
    public void visit(Host1 host1) {
        System.out.println("visit2 visit host1");
    }

    @Override
    public void visit(Host2 host2) {
        System.out.println("visit2 visit host2");
    }

    @Override
    public void visit(Host3 host3) {
        System.out.println("visit2 visit host3");
    }
}
